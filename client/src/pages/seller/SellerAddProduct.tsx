    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await axios.post(`${API_BASE}/seller/products`, {
                ...
                category: form.category,           // sent as string name — backend resolves
            ...
            <div className="max-w-2xl mx-auto">
                <div className="bg-white rounded-lg shadow-sm">
                    <div className="px-6 py-4 border-b border-gray-100">
                        <h2 className="font-semibold text-gray-800 text-[15px]">Add New Product</h2>
                        <p className="text-xs text-gray-500 mt-0.5">Product will be reviewed by admin before going live</p>
                    </div>
